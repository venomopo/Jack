...
TOKEN = '8002422434:AAHTh3In-I7kWxCRbtBTDBkmFxn8uwGrjIE'
MONGO_URI ='mongodb+srv://Dangerboyop:FJgjOtOZ2z8kUptY@dangerboyop.nyzgq.mongodb.net/'
FORWARD_CHANNEL_ID = -5915919192
CHANNEL_ID = -5915919192
error_channel_id = -5915919192
...
def create_inline_keyboard():
    ...
    button3 = types.InlineKeyboardButton(
        text="❤‍🩹 𝗝𝗼𝗶𝗻 𝗢𝘂𝗿 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 ❤‍🩹", url="https://t.me/venomxop123")
    button1 = types.InlineKeyboardButton(text="👤 𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗢𝘄𝗻𝗲𝗿 👤",
        url="https://t.me/venomxop123")
    markup.add(button3)
    markup.add(button1)
    return markup
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"
                                       ...
                                       "*Contact the owner for assistance: @VENOMXOP12.*", 
                                       reply_markup=create_inline_keyboard(), parse_mode='Markdown')
            return
        ...
        # Removed the cooldown check here
    ...
    try:
        ...
        if not user_data:
            ...
            button2 = types.InlineKeyboardButton(
                text="💸 𝗣𝗿𝗶𝗰𝗲 𝗟𝗶𝘀𝘁 💸", url="https://t.me/venomxop123/8436")
            markup.add(button1)
            markup.add(button2)
        else:
